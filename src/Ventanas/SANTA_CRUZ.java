...
public class SANTA_CRUZ extends javax.swing.JFrame {
DESTINOS vu;
...
private CSCircular c=new CSCircular(100);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 530, 100, -1));

        jScrollPane1.setViewportView(TablaTrans);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 190, 320, 150));

        jLabel4.setText("TRANSPORTE DISPONIBLE");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 170, -1, 25));

        jScrollPane2.setViewportView(TablaHotel1);

        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 340, 156));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 160, -1, -1));
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 360, 280, 170));
        ...
        getContentPane().add(COM_jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 400, 130, 30));
        ...
        getContentPane().add(COM_jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 440, 120, 20));
        ...
        getContentPane().add(idcancelar, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 120, 67, -1));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 490, -1, -1));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        while(!a.esVacia()){
            ...
            if(x.getIDdestino()==2){// AUI ESTOY VALIDADNDO CONEL ID DE DESTINO
        ...
        int sw=0;
            ...
            if(!r.esVacia()){
                ...
                for(int i=1;i<=nr;i++){
                    ...
                    if(res.getIDcliente().equals(ic) && res.getIDdestino()==2 && res.getEstado().equals("Reservado")){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SANTA_CRUZ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SANTA_CRUZ().setVisible(true);
            }
        });
    }
